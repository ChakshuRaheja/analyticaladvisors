...
const TermsAndConditions = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-16 pb-10 md:py-20 w-full">
      <div className="container mx-auto px-4 w-full">
        <div className="max-w-4xl mx-auto bg-white p-6 md:p-8 rounded-2xl shadow-2xl w-full mt-4 md:mt-0">
          ...
          <div className="prose prose-sm sm:prose-base md:prose-lg max-w-none">
            ...
            <p className="text-gray-700 mb-6">
              Thank you for showing your interest in www.analyticaladvisors.in. Please read these Terms of Service carefully as they constitute a legal agreement between you ("User") and Analytical Advisors. Analytical Advisors owns and controls this website, www.analyticaladvisors.in ("Website/AnalyticalAdvisors"), as well as the domain name. Analytical Advisors is a registered SEBI Research Analyst (Registration No.INH000020183) under the SEBI (Research Analysts) Regulations, 2014. By accessing or using the Website and/or any related mobile or software applications (collectively the "Sites"), accessing or using the content, information, services, features, or resources available or enabled through the Sites, including but not limited to information delivery through the Sites whether existing now or in the future that link to these Terms of Use (collectively with the Sites, the "Service"), however accessed or used, the User: (1) agrees to be bound by the Terms of Use; (2) These Terms of Service have an impact on the User's legal rights and obligations. Except as otherwise provided herein, the User may not access or use the Service if he or she does not agree to be bound by these Terms of Use. Please keep in mind that Analytical Advisors reserves the right to change these Terms of Service at any time and without prior notice to the User ("Updated Terms").
            </p>

            <section className="mb-8">
              <h2 className="text-xl md:text-2xl font-semibold mb-3 text-gray-800">1. Information and materials on this website may be used</h2>
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl font-semibold mb-3 text-gray-800">2. Intellectual Property</h2>
              <p className="text-gray-700">
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl font-semibold mb-3 text-gray-800">3. Maintaining Confidentiality</h2>
              <p className="text-gray-700">
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl font-semibold mb-3 text-gray-800">4. Eligibility</h2>
              <p className="text-gray-700">
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl font-semibold mb-3 text-gray-800">5. Termination & Refund Policy</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl font-semibold mb-3 text-gray-800">6. Other website links and non-transferable</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl font-semibold mb-3 text-gray-800">7. Alerts</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl font-semibold mb-3 text-gray-800">8. Indemnification</h2>
              <p className="text-gray-700">
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl font-semibold mb-3 text-gray-800">9. No Warranty</h2>
              <p className="text-gray-700">
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl font-semibold mb-3 text-gray-800">10. Severability</h2>
              <p className="text-gray-700">
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl font-semibold mb-3 text-gray-800">11. Recommendations, Conflicts, and Complaints</h2>
              <p className="text-gray-700">
                Customer Support should be contacted first at <a href="mailto:support@analyticaladvisors.in" className="text-blue-600 hover:underline">support@analyticaladvisors.in</a> with any suggestions or grievances.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-xl md:text-2xl font-semibold mb-3 text-gray-800">12. Privacy Principles</h2>
              <p className="text-gray-700">
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl font-semibold mb-3 text-gray-800">13. Statutes that apply</h2>
              <p className="text-gray-700">
                The laws of India apply to your use of this website and any Terms & Conditions. The Delhi court will have sole jurisdiction over any issues resulting from using the website.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-xl md:text-2xl font-semibold mb-3 text-gray-800">14. Additional</h2>
              <p className="text-gray-700">
